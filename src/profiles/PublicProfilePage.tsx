...
export function PublicProfilePage() {
  ...
  if (state === "not-found") return <section aria-labelledby="public-profile-title"><h1 id="public-profile-title">公开档案</h1><p role="status" aria-label="公开档案不存在">UID {uid} 尚无已合并的公开档案。</p></section>;
